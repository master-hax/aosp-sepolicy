...
def TestSystemTypeViolations(pol):
    return pol.AssertPathTypesHaveAttr(["/system/", "/system_ext/", "/product/"], ["/system/vendor/"], "system_file_type")
...
def TestVendorTypeViolations(pol):
    return pol.AssertPathTypesHaveAttr(["/system/vendor", "/vendor/", "/odm/"], [], "vendor_file_type")
