...
# Run host-side test with a contexts file and the sepolicy file.
# $(1): path to contexts file
...
$(eval $(call run_contexts_test, $(vendor_out)/vendor_property_contexts, $(property_info_checker),))
