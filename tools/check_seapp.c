...
static bool validate_bool(char *value, __attribute__ ((unused)) const char *filename, __attribute__ ((unused)) int lineno, char **errmsg) {
...
static bool validate_levelFrom(char *value, __attribute__ ((unused)) const char *filename, __attribute__ ((unused)) int lineno, char **errmsg) {
...
static bool validate_type(char *value, __attribute__ ((unused)) const char *filename, __attribute__ ((unused)) int lineno, char **errmsg) {
...
static bool validate_selinux_level(char *value, __attribute__ ((unused)) const char *filename, __attribute__ ((unused)) int lineno, char **errmsg) {
...
static bool validate_uint(char *value, __attribute__ ((unused)) const char *filename, __attribute__ ((unused)) int lineno, char **errmsg) {
...
static void validate() {
	...
	list_for_each(&coredomain_violation_list, cursor) {
		...
		fprintf(stderr, "Forbidden attribute " COREDOMAIN " assigned to domain \"%s\" in File \"%s\" on line %d\n", c->domain, c->filename, c->lineno);
	}
