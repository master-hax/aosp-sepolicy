...
def fetch_artifact(branch, pattern, destination='.'):
    ...
    cmd = [
        ...
        'aosp_arm64-userdebug', '--latest', pattern, destination
    ]
    check_run(cmd)
...
def download_mapping_file(branch, ver, destination='.', local=None):
    ...
    try:
        ...
        fetch_artifact(branch, artifact_pattern, temp_dir)
...
def main():
    ...
    download_mapping_file(args.branch, args.version)
