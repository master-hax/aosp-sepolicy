...
# adding the tests for version - 30 because system_ext policy introduced in android-R only.
...
# targeting the $(version) SELinux release.  This ensures that our policy will build
# when used on a device that has non-system_extform policy targeting the $(version) release.
...
# adding the tests for version - 30 because product policy introduced in android-R only.
...
# targeting the $(version) SELinux release.  This ensures that our policy will build
# when used on a device that has non-productform policy targeting the $(version) release.
