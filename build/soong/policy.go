...
func init() {
	...
	android.RegisterModuleType("se_policy_binary_cil", policyBinaryCilFactory)
}
...
type binaryCilProperties struct {
	...
	// Binary file to decompile to cil file.
	Src *string `android:"path"`

	// Additional cil files to be added in the end of the output.
	Additional_cil_files []string `android:"path"`
...
// se_policy_binary_cil decompiles a binary policy file to a cil file with checkpolicy.
// Sources of se_policy_binary_cil typically are the output of se_policy_binary modules.
func policyBinaryCilFactory() android.Module {
	c := &binaryCil{}
	c.AddProperties(&c.properties)
	android.InitAndroidArchModule(c, android.DeviceSupported, android.MultilibCommon)
	return c
