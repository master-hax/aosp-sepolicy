...
var (
	ServiceFuzzerBindings = map[string][]string{
		...
		"android.hardware.secure_element.ISecureElement/eSE1":                     []string{},
		"android.hardware.secure_element.ISecureElement/eSE2":                     []string{},
		"android.hardware.secure_element.ISecureElement/eSE3":                     []string{},
		"android.hardware.secure_element.ISecureElement/SIM1":                     []string{},
		"android.hardware.secure_element.ISecureElement/SIM2":                     []string{},
		"android.hardware.secure_element.ISecureElement/SIM3":                     []string{},
