...
var (
	ServiceFuzzerBindings = map[string][]string{
		...
		"android.hardware.automotive.remoteaccess.IRemoteAccess/default":          []string{"android.hardware.automotive.remoteaccess@V1-default-service.aidl_fuzzer"},
		"android.hardware.automotive.vehicle.IVehicle/default":                    []string{"android.hardware.automotive.vehicle@V1-default-service_fuzzer"},
