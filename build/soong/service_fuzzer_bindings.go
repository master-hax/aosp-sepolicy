...
var (
	ServiceFuzzerBindings = map[string][]string{
		...
		"android.hardware.vibrator.IVibratorManager/default":                      []string{"android.hardware.vibrator-service.example_fuzzer"},
                "android.hardware.vibrator.IVibratorController/default":                   EXCEPTION_NO_FUZZER,
                "android.hardware.vibrator.IVibratorControlService/default":               EXCEPTION_NO_FUZZER,
