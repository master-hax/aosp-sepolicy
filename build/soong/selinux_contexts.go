...
func fileContextsTestFactory() android.Module {
	m := &contextsTestModule{cType: FileContext}
...
func propertyContextsTestFactory() android.Module {
	m := &contextsTestModule{cType: PropertyContext}
	m.AddProperties(&m.properties)
	android.InitAndroidArchModule(m, android.DeviceSupported, android.MultilibCommon)
	return m
}
...
func hwserviceContextsTestFactory() android.Module {
	m := &contextsTestModule{cType: HwServiceContext}
	m.AddProperties(&m.properties)
	android.InitAndroidArchModule(m, android.DeviceSupported, android.MultilibCommon)
	return m
}
...
func serviceContextsTestFactory() android.Module {
	...
	m := &contextsTestModule{cType: ServiceContext}
	m.AddProperties(&m.properties)
	android.InitAndroidArchModule(m, android.DeviceSupported, android.MultilibCommon)
	return m
}
...
func vndServiceContextsTestFactory() android.Module {
	m := &contextsTestModule{cType: VndServiceContext}
	m.AddProperties(&m.properties)
	android.InitAndroidArchModule(m, android.DeviceSupported, android.MultilibCommon)
	return m
}
