...
def do_build_cil(args):
    ...
    checkpolicy_cmd += [os.path.join(args.host_out_executables, 'checkpolicy'),
    ...
    run_host_command([os.path.join(args.host_out_executables, 'version_policy'),
    ...
    if args.dependent_cils:
        merge_cmd = [os.path.join(args.host_out_executables, 'secilc'),
...
def run(argv):
    ...
    parser.add_argument('-e', '--host_out_executables', default='',
