...
ifneq (,$(BOARD_PLAT_PUBLIC_SEPOLICY_DIR))
  # Must use new variable name for devices launched on R
  ifdef PRODUCT_SHIPPING_API_LEVEL
    ifneq ($(call math_gt_or_eq,30,$(PRODUCT_SHIPPING_API_LEVEL)),)
      $(warning Please use SYSTEM_EXT_PUBLIC_SEPOLICY_DIRS instead of the old variable BOARD_PLAT_PUBLIC_SEPOLICY_DIR)
    endif
  endif
...
ifneq (,$(BOARD_PLAT_PRIVATE_SEPOLICY_DIR))
  ifdef PRODUCT_SHIPPING_API_LEVEL
    ifneq ($(call math_gt_or_eq,30,$(PRODUCT_SHIPPING_API_LEVEL)),)
      $(warning Please use SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS instead of the old variable BOARD_PLAT_PRIVATE_SEPOLICY_DIR)
    endif
  endif
