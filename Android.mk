...
ifneq ($(filter address,$(SANITIZE_TARGET)),)
  local_fc_files := $(wildcard $(addsuffix /file_contexts_asan, $(PLAT_PRIVATE_POLICY))) $(local_fc_files)
endif
ifneq (,$(filter userdebug eng,$(TARGET_BUILD_VARIANT)))
  local_fc_files := $(wildcard $(addsuffix /file_contexts_overlayfs, $(PLAT_PRIVATE_POLICY))) $(local_fc_files)
endif
