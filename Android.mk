...
$(warning Be careful when using the IGNORE_NEVERALLOWS flag. \
          It does not work in user builds and using it will \
          not stop you from failing CTS.)
PRIVATE_NEVERALLOW_ARG := -N
endif
...
# If IGNORE_NEVERALLOWS is set, we use sed to remove the neverallow lines before compiling.
