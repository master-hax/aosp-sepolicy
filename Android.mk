...
base_system_ext_public := $(SYSTEM_EXT_PUBLIC_POLICY)
base_system_ext_private := $(SYSTEM_EXT_PRIVATE_POLICY)
base_system_ext_public_prebuilt := \
  $(SYSTEM_EXT_PREBUILT_POLICY)/prebuilts/api/$(PLATFORM_SEPOLICY_VERSION)/public

base_system_ext_private_prebuilt := \
  $(SYSTEM_EXT_PREBUILT_POLICY)/prebuilts/api/$(PLATFORM_SEPOLICY_VERSION)/private
...
base_product_public := $(PRODUCT_PUBLIC_POLICY)
base_product_private := $(PRODUCT_PRIVATE_POLICY)
base_product_public_prebuilt := \
  $(PRODUCT_PREBUILT_POLICY)/prebuilts/api/$(PLATFORM_SEPOLICY_VERSION)/public

base_product_private_prebuilt := \
  $(PRODUCT_PREBUILT_POLICY)/prebuilts/api/$(PLATFORM_SEPOLICY_VERSION)/private
