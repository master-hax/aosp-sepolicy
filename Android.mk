...
define ziplist
$(if $(and $1,$2), "$(firstword $1) $(firstword $2)" $(call ziplist,$(wordlist 2,$(words $1),$1),$(wordlist 2,$(words $2),$2)))
endef
...
ifneq ($(PLATFORM_SEPOLICY_VERSION),$(TOT_SEPOLICY_VERSION))
	@for tuple in $(call ziplist, $(PRIVATE_EXTRA_PUBLIC_PREBUILT), $(PRIVATE_EXTRA_PUBLIC)); do diff -rq $$tuple; done
	@for tuple in $(call ziplist, $(PRIVATE_EXTRA_PRIVATE_PREBUILT), $(PRIVATE_EXTRA_PRIVATE)); do diff -rq $$tuple; done
endif # ($(PLATFORM_SEPOLICY_VERSION),$(TOT_SEPOLICY_VERSION))
	$(hide) touch $@
