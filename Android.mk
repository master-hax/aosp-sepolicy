...
sepolicy_intermediates := $(TARGET_OUT_INTERMEDIATES)/ETC/sepolicy_intermediates
...
reqd_policy_mask.conf := $(sepolicy_intermediates)/reqd_policy_mask.conf
...
reqd_policy_mask.cil := $(sepolicy_intermediates)/reqd_policy_mask.cil
...
ifeq ($(PLATFORM_SEPOLICY_VERSION),$(BOARD_SEPOLICY_VERS))
...
sepolicy_policy.conf := $(sepolicy_intermediates)/policy.conf
...
sepolicy_policy_2.conf := $(sepolicy_intermediates)/policy_2.conf
...
# sepolicy_policy.conf - All of the policy for the device.  This is only used to
# check neverallow rules.
sepolicy_policy.conf := $(sepolicy_intermediates)/policy_vendor.conf
$(sepolicy_policy.conf): PRIVATE_MLS_SENS := $(MLS_SENS)
$(sepolicy_policy.conf): PRIVATE_MLS_CATS := $(MLS_CATS)
$(sepolicy_policy.conf): PRIVATE_TARGET_BUILD_VARIANT := user
$(sepolicy_policy.conf): PRIVATE_TGT_ARCH := $(my_target_arch)
...
# sepolicy_policy_2.conf - All of the policy for the device.  This is only used to
# check neverallow rules using sepolicy-analyze, similar to CTS.
sepolicy_policy_2.conf := $(sepolicy_intermediates)/policy_vendor_2.conf
$(sepolicy_policy_2.conf): PRIVATE_MLS_SENS := $(MLS_SENS)
$(sepolicy_policy_2.conf): PRIVATE_MLS_CATS := $(MLS_CATS)
$(sepolicy_policy_2.conf): PRIVATE_TARGET_BUILD_VARIANT := user
$(sepolicy_policy_2.conf): PRIVATE_EXCLUDE_BUILD_TEST := true
...
endif # ifneq ($(PLATFORM_SEPOLICY_VERSION),$(BOARD_SEPOLICY_VERS))
...
pub_policy.conf := $(sepolicy_intermediates)/pub_policy.conf
...
$(pub_policy.conf): $(policy_files) $(M4)
	$(transform-policy-to-conf)
pub_policy.cil := $(sepolicy_intermediates)/pub_policy.cil
...
system_ext_pub_policy.conf := $(sepolicy_intermediates)/system_ext_pub_policy.conf
...
system_ext_pub_policy.cil := $(sepolicy_intermediates)/system_ext_pub_policy.cil
...
plat_pub_policy.conf := $(sepolicy_intermediates)/plat_pub_policy.conf
...
plat_pub_policy.cil := $(sepolicy_intermediates)/plat_pub_policy.cil
...
plat_policy.conf := $(sepolicy_intermediates)/plat_policy.conf
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  $(PLAT_PUBLIC_POLICY) $(PLAT_PRIVATE_POLICY))
userdebug_plat_policy.conf := $(sepolicy_intermediates)/userdebug_plat_policy.conf
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  $(PLAT_PUBLIC_POLICY) $(PLAT_PRIVATE_POLICY) \
  $(SYSTEM_EXT_PUBLIC_POLICY) $(SYSTEM_EXT_PRIVATE_POLICY))
system_ext_policy.conf := $(sepolicy_intermediates)/system_ext_policy.conf
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  ...
  $(SYSTEM_EXT_PUBLIC_POLICY) $(SYSTEM_EXT_PRIVATE_POLICY) \
  $(PRODUCT_PUBLIC_POLICY) $(PRODUCT_PRIVATE_POLICY))
product_policy.conf := $(sepolicy_intermediates)/product_policy.conf
...
vendor_policy.conf := $(sepolicy_intermediates)/vendor_policy.conf
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  ...
  $(product_public_policy_$(BOARD_SEPOLICY_VERS)) $(reqd_policy_$(BOARD_SEPOLICY_VERS)) \
  $(BOARD_PLAT_VENDOR_POLICY) $(BOARD_VENDOR_SEPOLICY_DIRS) $(BOARD_ODM_SEPOLICY_DIRS))
odm_policy.conf := $(sepolicy_intermediates)/odm_policy.conf
...
# We don't need vendor policies because recovery partition is standalone.
policy_files := $(call build_policy, $(sepolicy_build_files), \
  $(PLAT_PUBLIC_POLICY) $(PLAT_PRIVATE_POLICY) \
  $(SYSTEM_EXT_PUBLIC_POLICY) $(SYSTEM_EXT_PRIVATE_POLICY) \
  $(PRODUCT_PUBLIC_POLICY) $(PRODUCT_PRIVATE_POLICY))
sepolicy.recovery.conf := $(sepolicy_intermediates)/sepolicy.recovery.conf
...
file_contexts.local.tmp := $(sepolicy_intermediates)/file_contexts.local.tmp
...
file_contexts.modules.tmp := $(sepolicy_intermediates)/file_contexts.modules.tmp
...
file_contexts.device.tmp := $(sepolicy_intermediates)/file_contexts.device.tmp
...
file_contexts.device.sorted.tmp := $(sepolicy_intermediates)/file_contexts.device.sorted.tmp
...
file_contexts.concat.tmp := $(sepolicy_intermediates)/file_contexts.concat.tmp
$(call merge-fc-files,\
...
vndservice_contexts.tmp := $(sepolicy_intermediates)/vndservice_contexts.tmp
...
##################################
sepolicy_intermediates := $(call intermediates-dir-for,ETC,built_plat_sepolicy,,,,)
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  $(PLAT_PUBLIC_POLICY) $(PLAT_PRIVATE_POLICY))
base_plat_policy.conf := $(sepolicy_intermediates)/base_plat_policy.conf
...
built_plat_sepolicy := $(sepolicy_intermediates)/built_plat_sepolicy
...
policy_files := $(call build_policy, $(sepolicy_build_files), \
  $(PLAT_PUBLIC_POLICY) $(REQD_MASK_POLICY))
base_plat_pub_policy.conf := $(sepolicy_intermediates)/base_plat_pub_policy.conf
...
base_plat_pub_policy.cil := $(sepolicy_intermediates)/base_plat_pub_policy.cil
