...
##################################
include $(LOCAL_PATH)/file_contexts_tests.mk

##################################
include $(LOCAL_PATH)/seapp_contexts.mk

##################################
include $(LOCAL_PATH)/property_contexts_tests.mk

##################################
include $(LOCAL_PATH)/service_contexts_tests.mk

##################################
include $(LOCAL_PATH)/hwservice_contexts_tests.mk
