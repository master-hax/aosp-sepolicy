...
##################################
# TODO - remove this.   Keep around until we et the filesystem creation stuff taken care of.
#
include $(CLEAR_VARS)
...
$(LOCAL_BUILT_MODULE): PRIVATE_SEPOLICY := $(built_sepolicy)
$(LOCAL_BUILT_MODULE): $(HOST_OUT_EXECUTABLES)/checkfc $(local_fcfiles_with_nl) $(built_sepolicy)
	@mkdir -p $(dir $@)
...
$(LOCAL_BUILT_MODULE): PRIVATE_FC_FILES := $(device_fcfiles_with_nl)
$(LOCAL_BUILT_MODULE): PRIVATE_SEPOLICY := $(built_sepolicy)
